...
def example_with_base64_image():
    ...
    with BaseResponse(
        ...
        result = response.run_sync(
            "What's in this image?", images="path_to_your_image.jpg"
        )
        print(result)
...
def example_with_base64_file():
    ...
    with BaseResponse(
        ...
        result = response.run_sync(
            "What is the first dragon in the book?", file_data="draconomicon.pdf"
        )
        print(result)
...
def example_from_problem_statement_images():
    ...
    with BaseResponse(
        ...
        result = response.run_sync(
            ...
            images="path_to_your_image.jpg",  # Handles encoding automatically
        )
        print(result)
